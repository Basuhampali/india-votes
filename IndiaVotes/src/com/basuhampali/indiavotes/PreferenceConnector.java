...
public class PreferenceConnector{
	public static final String PREF_NAME = "VOTE_INDIA";
	public static final int MODE = Context.MODE_PRIVATE;
	
	public static final String VOTER_ID = "VOTER_ID";
	public static final String NAME = "NAME";
	public static final String ASSEMBLY_NO_AND_NAME = "ASSEMBLY_NO_AND_NAME";
	public static final String POLLING_BOTH_ADDRESS = "POLLING_BOTH_ADDRESS";
	public static final String SERIAL_NO = "S_NO";
	public static final String CARE_OF = "CO";
